...
- fps
    ...
    - Python dtype: int
- preserve_alpha
    - The preserve_alpha input is used by this node during execution.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- loop_count
    - The loop_count input is used by this node during execution.
    - Comfy dtype: INT
    - Python dtype: int
- quality
...
## Optional
- metadata_comment
    - The metadata_comment input is used by this node during execution.
    - Comfy dtype: STRING
    - Python dtype: str
