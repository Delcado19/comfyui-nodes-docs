# Documentation
- Class name: VRGDG_PromptSplitterForManual
- Category: VRGDG
- Output node: False
- Repo Ref: https://github.com/vrgamegirl19/comfyui-vrgamedevgirl

✂️ VRGDG_PromptSplitterForManual is a ComfyUI node registered by `custom_nodes.comfyui-vrgamedevgirl`. The live metadata did not provide a longer description.
