# Documentation
- Class name: Lora Cycler (LoraManager)
...
## Required
- cycler_config
    - The cycler_config input is used by this node during execution.
    - Comfy dtype: CYCLER_CONFIG
    - Python dtype: object
## Optional
- pool_config
    - The pool_config input is used by this node during execution.
    - Comfy dtype: POOL_CONFIG
    - Python dtype: object
