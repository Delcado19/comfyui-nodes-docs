# Documentation
- Class name: SDLoraLoader
- Category: SD Prompt Reader
- Output node: False
- Repo Ref: https://github.com/receyuki/comfyui-prompt-reader-node

SD Lora Loader is a ComfyUI node registered by `custom_nodes.comfyui-prompt-reader-node`. The live metadata did not provide a longer description.
...
- strength_model
    ...
    - Python dtype: float
- strength_clip
    - The strength_clip input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
## Optional
- last_lora
    - The last_lora input is used by this node during execution.
    - Comfy dtype: *
    - Python dtype: object
...
- CLIP
    ...
    - Python dtype: object
- NEXT_LORA
    - The NEXT_LORA output is produced by this node.
    - Comfy dtype: *
    - Python dtype: object
