...
- description
    ...
    - Python dtype: str
- llm_index
    - Identifies the specific index or database to query, enabling targeted information retrieval based on the input query.
    - Comfy dtype: LLM_INDEX
    - Python dtype: LLM_INDEX

# Output types
- query_tool
    - The node's output, including the tool configured for query processing, encapsulating the function and its parameters.
    - Comfy dtype: TOOL
