# Documentation
- Class name: WanContextWindowsManual
...
- context_length
    - The length of the context window in real frames. Must be 4*n + 1.
    - Comfy dtype: INT
    - Python dtype: int
- context_overlap
...
- freenoise
    ...
    - Python dtype: bool
- retain_first_frame
    - Retain the first I2V frame in every context window (may help retain initial reference).
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
