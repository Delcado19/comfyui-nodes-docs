# Documentation
- Class name: ModelMergeCosmos14B
- Category: model/merging/model specific
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

ModelMergeCosmos14B is a ComfyUI node registered by `comfy_extras.nodes_model_merging_model_specific`. The live metadata did not provide a longer description.
...
- blocks.block27.
    ...
    - Python dtype: float
- blocks.block28.
    - The blocks.block28. input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- blocks.block29.
    - The blocks.block29. input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- blocks.block30.
    - The blocks.block30. input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- blocks.block31.
    - The blocks.block31. input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- blocks.block32.
    - The blocks.block32. input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- blocks.block33.
    - The blocks.block33. input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- blocks.block34.
    - The blocks.block34. input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- blocks.block35.
    - The blocks.block35. input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- final_layer.
