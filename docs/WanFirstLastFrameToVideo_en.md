# Documentation
- Class name: WanFirstLastFrameToVideo
- Category: model/conditioning/wan
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

WanFirstLastFrameToVideo is a ComfyUI node registered by `comfy_extras.nodes_wan`. The live metadata did not provide a longer description.
