# Documentation
- Class name: EmptyChromaRadianceLatentImage
- Category: model/latent/chroma radiance
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

EmptyChromaRadianceLatentImage is a ComfyUI node registered by `comfy_extras.nodes_chroma_radiance`. The live metadata did not provide a longer description.
