# Documentation
- Class name: TextEncodeAceStepAudio
- Category: model/conditioning/ace
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

TextEncodeAceStepAudio is a ComfyUI node registered by `comfy_extras.nodes_ace`. The live metadata did not provide a longer description.
...
- lyrics
    ...
    - Python dtype: str
- lyrics_strength
    - The lyrics_strength input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
