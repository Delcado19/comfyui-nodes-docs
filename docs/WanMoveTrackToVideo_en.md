# Documentation
- Class name: WanMoveTrackToVideo
- Category: model/conditioning/wan/move
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

WanMoveTrackToVideo is a ComfyUI node registered by `comfy_extras.nodes_wanmove`. The live metadata did not provide a longer description.
