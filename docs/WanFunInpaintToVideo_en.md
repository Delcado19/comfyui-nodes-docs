# Documentation
- Class name: WanFunInpaintToVideo
- Category: model/conditioning/wan/fun inpaint
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

WanFunInpaintToVideo is a ComfyUI node registered by `comfy_extras.nodes_wan`. The live metadata did not provide a longer description.
