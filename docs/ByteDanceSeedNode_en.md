# Documentation
- Class name: ByteDanceSeedNode
- Category: partner/text/ByteDance
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

Generate text responses with ByteDance's Seed 2.0 models. Provide a text prompt and optionally one or more images or videos for multimodal context.
...
- prompt
    ...
    - Python dtype: str
- model
    - The Seed model used to generate the response.
