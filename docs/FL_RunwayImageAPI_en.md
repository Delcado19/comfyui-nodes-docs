...
- image3
    ...
    - Python dtype: torch.Tensor
- tag1
    - The tag1 input is used by this node during execution.
    - Comfy dtype: STRING
    - Python dtype: str
- tag2
    - The tag2 input is used by this node during execution.
    - Comfy dtype: STRING
    - Python dtype: str
- tag3
    - The tag3 input is used by this node during execution.
    - Comfy dtype: STRING
    - Python dtype: str
- seed
