...
This node is specifically designed for fetching and processing images from URLs, supports handling various image formats, and provides an option to preserve transparency information.

# Input types
## Required
- url
    - Specify the URL of the image to load, supporting multiple sources.
    - Comfy dtype: STRING
    - Python dtype: str
## Optional
- keep_alpha_channel
    - Indicates whether the transparency channel of the image should be preserved, useful for images where transparency is critical.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
- output_mode
    - Controls the output format of the image, providing options between list and batch processing modes for flexible handling of loaded images.
    - Comfy dtype: BOOLEAN
    - Python dtype: str

# Output types
- images
    - The loaded image, which may include transparency information if specified.
    - Comfy dtype: IMAGE
    - Python dtype: torch.Tensor
- masks
    - A mask generated from the image, used for further image processing tasks.
    - Comfy dtype: MASK
    - Python dtype: torch.Tensor
- has_image
    - A boolean indicator representing whether the image was successfully loaded.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
