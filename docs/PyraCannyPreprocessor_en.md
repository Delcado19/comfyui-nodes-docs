# Documentation
- Class name: PyraCannyPreprocessor
...
## Optional
- low_threshold
    - The low_threshold input is used by this node during execution.
    - Comfy dtype: INT
    - Python dtype: int
- high_threshold
    - The high_threshold input is used by this node during execution.
    - Comfy dtype: INT
    - Python dtype: int
- resolution
