# Documentation
- Class name: Read JSON file [Crystools]
...
## Optional
- path_to_json
    - The path_to_json input is used by this node during execution.
    - Comfy dtype: STRING
    - Python dtype: str
...
# Source code
[View source repository](https://github.com/crystian/ComfyUI-Crystools)
