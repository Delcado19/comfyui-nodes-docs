# Documentation
- Class name: Kandinsky5ImageToVideo
- Category: model/conditioning/kandinsky
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

Kandinsky5ImageToVideo is a ComfyUI node registered by `comfy_extras.nodes_kandinsky5`. The live metadata did not provide a longer description.
