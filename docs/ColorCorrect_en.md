...
The ColorCorrect node is designed to adjust and enhance the color properties of an image, including temperature, hue, brightness, contrast, saturation, and gamma. It employs advanced image processing techniques to fine-tune these attributes, thereby improving the overall visual quality of the image.

# Input types
## Required
- image
    - The input image tensor that requires color correction. It serves as the foundation for applying various color adjustments.
    - Comfy dtype: IMAGE
...
- temperature
    ...
    - Python dtype: float
- hue
    - Modifies the hue of the image, shifting colors along the color spectrum.
    - Comfy dtype: FLOAT
    - Python dtype: float
- brightness
    - Controls the brightness level of the image, making it brighter or darker.
    - Comfy dtype: FLOAT
    - Python dtype: float
- contrast
    ...
    - Python dtype: float
- saturation
    - Adjusts the saturation level, affecting the intensity of colors in the image.
    - Comfy dtype: FLOAT
    - Python dtype: float
- gamma
    - Applies gamma correction to the image, adjusting luminance or lightness.
    - Comfy dtype: FLOAT
    - Python dtype: float
