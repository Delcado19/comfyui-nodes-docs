...
The HintImageEnhance node is designed to enhance and resize hint images to fit image generation tasks. It supports multiple resizing modes to match the dimensions of the generated image, ensuring that hint images are properly scaled and processed to perform optimally during the generation process.

# Input types
## Required
- hint_image
    - A collection of hint images that need enhancement and resizing. These images serve as guidance for the image generation process, influencing the appearance of the output.
    - Comfy dtype: IMAGE
    - Python dtype: List[torch.Tensor]
- image_gen_width
    - The target width of the generated image. This parameter determines how hint images are resized horizontally.
    - Comfy dtype: INT
    - Python dtype: int
- image_gen_height
    - The target height of the generated image. This parameter affects how hint images are resized vertically.
    - Comfy dtype: INT
    - Python dtype: int
- resize_mode
    - Specifies the resizing mode applied to hint images, such as fitting within the target dimensions or stretching to the target dimensions.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: ResizeMode

# Output types
- image
    - Enhanced and resized hint images, ready for direct use in the image generation process.
    - Comfy dtype: IMAGE
