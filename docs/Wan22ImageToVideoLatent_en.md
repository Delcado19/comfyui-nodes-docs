# Documentation
- Class name: Wan22ImageToVideoLatent
- Category: model/conditioning/wan
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

Wan22ImageToVideoLatent is a ComfyUI node registered by `comfy_extras.nodes_wan`. The live metadata did not provide a longer description.
