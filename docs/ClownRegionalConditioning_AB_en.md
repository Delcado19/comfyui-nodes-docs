# Documentation
- Class name: ClownRegionalConditioning_AB
- Category: RES4LYF/conditioning
- Output node: False
- Repo Ref: https://github.com/ClownsharkBatwing/RES4LYF

ClownRegionalConditioning_AB is a ComfyUI node registered by `custom_nodes.RES4LYF`. The live metadata did not provide a longer description.
