# Documentation
- Class name: LayerMask: SegformerClothesSetting
...
- hat
    ...
    - Python dtype: bool
- sunglass
    - The sunglass input is used by this node during execution.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
- left_arm
    - The left_arm input is used by this node during execution.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
- right_arm
    - The right_arm input is used by this node during execution.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
- left_leg
    - The left_leg input is used by this node during execution.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
- right_leg
    - The right_leg input is used by this node during execution.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
- left_shoe
    - The left_shoe input is used by this node during execution.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
- right_shoe
    - The right_shoe input is used by this node during execution.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
- upper_clothes
    - The upper_clothes input is used by this node during execution.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
- skirt
...
- segformer_clothes_setting
    - The segformer_clothes_setting output is produced by this node.
