# Documentation
- Class name: VRGDG_UpdateLatestCombinedJsonPrompts_zimage
- Category: VRGDG/General
- Output node: False
- Repo Ref: https://github.com/vrgamegirl19/comfyui-vrgamedevgirl

VRGDG_UpdateLatestCombinedJsonPrompts_zimage is a ComfyUI node registered by `custom_nodes.comfyui-vrgamedevgirl`. The live metadata did not provide a longer description.
