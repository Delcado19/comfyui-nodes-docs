# Documentation
- Class name: SaveGaussianSplat
- Category: 3d
- Output node: True
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

Save Splat is a ComfyUI node registered by `comfy_extras.nodes_save_3d`. The live metadata did not provide a longer description.
