...
- text
    ...
    - Python dtype: str
- output_file_path
    - The output_file_path input is used by this node during execution.
    - Comfy dtype: STRING
    - Python dtype: str
- file_name
    ...
    - Python dtype: str
- file_extension
    - The file_extension input is used by this node during execution.
    - Comfy dtype: COMBO
    - Python dtype: object
- overwrite
