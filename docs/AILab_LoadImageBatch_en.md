# Documentation
- Class name: AILab_LoadImageBatch
...
## Required
- path_or_urls
    - The path_or_urls input is used by this node during execution.
    - Comfy dtype: STRING
    - Python dtype: str
- upscale_method
...
## Optional
- batch_size
    - Number of images to load (0 = all images)
    - Comfy dtype: INT
    - Python dtype: int
- start_from
    - Start from Nth image (1 = first image)
    - Comfy dtype: INT
    - Python dtype: int
- sort_method
    - Image loading order: sequential/reverse/random
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
## Hidden
- extra_pnginfo
