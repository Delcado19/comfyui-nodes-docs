...
This node is specifically designed for blending two sets of images together using various blending modes. It allows adjusting the blending percentage and applying masks to control the blending process, providing a flexible method for creating composite images.

# Input types
## Required
- images_a
    - The first set of images to blend. These images serve as the base layer in the blending process.
    - Comfy dtype: IMAGE
    - Python dtype: torch.Tensor
- images_b
    - The second set of images to blend with the first set. These images serve as the overlay layer.
    - Comfy dtype: IMAGE
    - Python dtype: torch.Tensor
- mode
    - Specifies the blending mode to use. Each mode applies a different algorithm to combine the images, affecting the visual result of the blend.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: List[str]
- blend_percentage
    - Determines the blending intensity between the two sets of images. A higher percentage results in a stronger presence of the overlay images.
    - Comfy dtype: FLOAT
    - Python dtype: float
## Optional
- masks
    - An optional mask that can be applied to the images to control where blending occurs. Useful for creating more precise or complex composite images.
    - Comfy dtype: MASK
    - Python dtype: Optional[torch.Tensor]

# Output types
- images
    - The blended set of images.
    - Comfy dtype: IMAGE
    - Python dtype: torch.Tensor
