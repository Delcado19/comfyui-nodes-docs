...
This node facilitates manual input of X and Y values for plotting, allowing users to directly define and manipulate XY data points. It supports multiple input formats and types, enabling users to customize data for XY chart visualization.

# Input types
## Required
- plot_type
    - Specify the type of chart to be generated, affecting how XY data is interpreted and visualized.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- plot_value
    - Determine the specific values for plotting, directly affecting the appearance of the chart and the representation of data.
    - Comfy dtype: STRING
    - Python dtype: str

# Output types
- X or Y
    - Output X or Y values, depending on the node's processing, suitable for further visualization or analysis.
    - Comfy dtype: XY
    - Python dtype: tuple
