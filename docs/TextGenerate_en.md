# Documentation
- Class name: TextGenerate
- Category: text
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

Generate Text is a ComfyUI node registered by `comfy_extras.nodes_textgen`. The live metadata did not provide a longer description.
