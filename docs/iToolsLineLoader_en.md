# Documentation
- Class name: iToolsLineLoader
- Category: iTools
- Output node: False
- Repo Ref: https://github.com/MohammadAboulEla/ComfyUI-iTools

Will return a line from a multi line text at given index, note that count start from zero.

# Input types
## Required
- lines
    - The lines input is used by this node during execution.
    - Comfy dtype: STRING
    - Python dtype: str
- seed
...
# Output types
- line loaded
    - The line loaded output is produced by this node.
    - Comfy dtype: STRING
    - Python dtype: str
- count
