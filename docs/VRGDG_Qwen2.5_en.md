# Documentation
- Class name: VRGDG_Qwen2.5
- Category: VRGDG/LLM
- Output node: False
- Repo Ref: https://github.com/vrgamegirl19/comfyui-vrgamedevgirl

🧠 VRGDG Qwen 2.5 🧠 is a ComfyUI node registered by `custom_nodes.comfyui-vrgamedevgirl`. The live metadata did not provide a longer description.
