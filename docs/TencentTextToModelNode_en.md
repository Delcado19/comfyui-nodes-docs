# Documentation
- Class name: TencentTextToModelNode
- Category: partner/3d/Tencent
- Output node: True
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

Hunyuan3D: Text to Model is a ComfyUI node registered by `comfy_api_nodes.nodes_hunyuan3d`. The live metadata did not provide a longer description.
