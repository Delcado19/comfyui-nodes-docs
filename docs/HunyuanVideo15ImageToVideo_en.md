# Documentation
- Class name: HunyuanVideo15ImageToVideo
- Category: model/conditioning/hunyuan video
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

HunyuanVideo15ImageToVideo is a ComfyUI node registered by `comfy_extras.nodes_hunyuan`. The live metadata did not provide a longer description.
