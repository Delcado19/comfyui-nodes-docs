# Documentation
- Class name: ClownModelLoader
- Category: RES4LYF/loaders
- Output node: False
- Repo Ref: https://github.com/ClownsharkBatwing/RES4LYF

ClownModelLoader is a ComfyUI node registered by `custom_nodes.RES4LYF`. The live metadata did not provide a longer description.
...
- weight_dtype
    ...
    - Python dtype: str
- clip_name1_opt
    - The clip_name1_opt input is used by this node during execution.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- clip_name2_opt
...
- clip_name3_opt
    ...
    - Python dtype: str
- clip_name4_opt
    - The clip_name4_opt input is used by this node during execution.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- clip_type
    - The clip_type input is used by this node during execution.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- vae_name
