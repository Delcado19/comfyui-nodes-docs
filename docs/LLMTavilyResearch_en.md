...
LLMTavilyResearch node is designed to leverage advanced language models for in-depth research and analysis. It processes and interprets large volumes of text data to provide comprehensive insights and summaries.

# Input types
## Required
- tavily_api_key
    - API key for Tavily, used to access and utilize Tavily's research services.
    - Comfy dtype: STRING
    - Python dtype: str
- search_query
    - The search query or topic to be researched.
    - Comfy dtype: STRING
    - Python dtype: str

## Optional
- search_depth
    - Defines the depth or breadth of the search, potentially affecting the level of detail in the results.
...
- max_results
    ...
    - Python dtype: int
- include_answer
    - Determines whether to include direct answers in the results.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
- include_raw_content
    - Determines whether to include raw content in the results.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
- include_domains
    - Specifies a list of domains to include in the search.
    - Comfy dtype: STRING
    - Python dtype: str
- exclude_domains
    - Specifies a list of domains to exclude from the search.
    - Comfy dtype: STRING
    - Python dtype: str
- keep_looking_limit
    - Sets limits for continuing the search, potentially affecting the duration or depth of the search.
    - Comfy dtype: INT
    - Python dtype: int

# Output types
- documents
    - Processed and analyzed text data, structured and provided with insights.
    - Comfy dtype: DOCUMENT
    - Python dtype: List[str]
- urls
    - A collection of URLs cited or extracted during the research process.
    - Comfy dtype: LIST
    - Python dtype: List[str]
