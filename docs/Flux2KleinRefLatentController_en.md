# Documentation
- Class name: Flux2KleinRefLatentController
...
## Optional
- spatial_fade
    - The spatial_fade input is used by this node during execution.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- spatial_fade_strength
    - The spatial_fade_strength input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- debug
