# Documentation
- Class name: PairConditioningSetPropertiesAndCombine
- Category: advanced/hooks/cond pair
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

Cond Pair Set Props Combine is a ComfyUI node registered by `comfy_extras.nodes_hooks`. The live metadata did not provide a longer description.
