...
- denoise
    ...
    - Python dtype: float
- x_axis
    - The x_axis input is used by this node during execution.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- x_values
    - The x_values input is used by this node during execution.
    - Comfy dtype: STRING
    - Python dtype: str
- y_axis
    - The y_axis input is used by this node during execution.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- y_values
    - The y_values input is used by this node during execution.
    - Comfy dtype: STRING
    - Python dtype: str
- z_axis
    - The z_axis input is used by this node during execution.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- z_values
    - The z_values input is used by this node during execution.
    - Comfy dtype: STRING
    - Python dtype: str
- z_stack_mode
    - The z_stack_mode input is used by this node during execution.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
## Optional
- latent_image
