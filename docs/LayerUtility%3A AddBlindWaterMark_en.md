...
Add invisible watermark to images. Add the watermark image in a way imperceptible to the naked eye, and use the ShowBlindWaterMark node to decode the watermark.
