# Documentation
- Class name: VAEEncodeAdvanced
- Category: RES4LYF/vae
- Output node: False
- Repo Ref: https://github.com/ClownsharkBatwing/RES4LYF

VAEEncodeAdvanced is a ComfyUI node registered by `custom_nodes.RES4LYF`. The live metadata did not provide a longer description.
