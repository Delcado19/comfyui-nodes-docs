...
The ttN_pipeKSamplerSDXL_v2 node is designed to facilitate advanced image sampling processes, integrating various techniques and parameters to enhance and customize image generation. It utilizes a sophisticated sampling algorithm that allows detailed control over the image generation process, including noise management, denoising, and applying LoRA adjustments to fine-tune the model.
...
- lora_name
    - Specifies the name of the LoRA parameter to adjust, playing a key role in fine-tuning model behavior and output quality.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- lora_strength
    - Determines the strength of the LoRA adjustment, directly affecting the model's output by altering its internal representations.
    - Comfy dtype: FLOAT
    - Python dtype: float
- upscale_method
    - Specifies the method used to upscale the generated image, affecting the image's resolution and clarity.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- upscale_model_name
    - Unknown
    ...
    - Python dtype: unknown
- factor
    - Determines the magnification factor for image upscaling, directly impacting the final image size and detail.
    - Comfy dtype: FLOAT
    - Python dtype: float
- rescale
    - Unknown
...
- crop
    ...
    - Python dtype: unknown
- sampler_state
    - Controls the state of the sampler, influencing the sampling process and final image generation.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- base_steps
    - Unknown
    ...
    - Python dtype: unknown
- cfg
    - Configures the sampling process, allowing customization of generation parameters.
    - Comfy dtype: FLOAT
    - Python dtype: float
- denoise
    - Unknown
...
- refiner_denoise
    ...
    - Python dtype: unknown
- sampler_name
    - Identifies the specific sampler algorithm to use, affecting the style and characteristics of the generated image.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- scheduler
    ...
    - Python dtype: str
- image_output
    - Determines the output format and processing method for the generated image, including save or display options.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- save_prefix
...
- seed
    ...
    - Python dtype: unknown
- ui
    - Provides a user interface component that displays the results of the image generation process, including the generated image and possible additional information.
