...
The Image Inset Crop (rgthree) node allows users to crop images based on specified inset values (defined in pixels or percentages). This feature provides precise control over the cropped area, enabling users to adjust the visible portion of the image as needed.

# Input types
## Required
- image
    - The image to be cropped. This input is essential for defining the source image on which the crop operation will be performed.
    - Comfy dtype: IMAGE
    - Python dtype: torch.Tensor
- measurement
    - Specifies the unit of measurement for inset values (pixels or percentages). This determines how the inset values are interpreted and applied to the crop operation.
...
- right
    ...
    - Python dtype: int
- top
    - The inset value from the top edge of the image. This defines how much of the top of the image will be cropped.
    - Comfy dtype: INT
    - Python dtype: int
- bottom
    - The inset value from the bottom edge of the image. This defines how much of the bottom of the image will be cropped.
    - Comfy dtype: INT
    - Python dtype: int
