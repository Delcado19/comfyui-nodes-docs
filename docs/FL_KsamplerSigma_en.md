...
- denoise
    ...
    - Python dtype: float
- sigma_max_hint
    - The sigma_max_hint input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- sigma_min_hint
    - The sigma_min_hint input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- schedule_curve
    - The schedule_curve input is used by this node during execution.
    - Comfy dtype: STRING
    - Python dtype: str
## Optional
- latent_image
