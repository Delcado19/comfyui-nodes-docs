# Documentation
- Class name: VRGDG_CreateFinalVideo_SRT
- Category: Video
- Output node: True
- Repo Ref: https://github.com/vrgamegirl19/comfyui-vrgamedevgirl

VRGDG_CreateFinalVideo_SRT is a ComfyUI node registered by `custom_nodes.comfyui-vrgamedevgirl`. The live metadata did not provide a longer description.
...
- threshold
    ...
    - Python dtype: int
- group_list
    - The group_list input is used by this node during execution.
    - Comfy dtype: STRING
    - Python dtype: str
- video_folder
    - The video_folder input is used by this node during execution.
    - Comfy dtype: STRING
    - Python dtype: str
