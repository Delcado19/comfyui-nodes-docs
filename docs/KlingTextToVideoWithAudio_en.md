# Documentation
- Class name: KlingTextToVideoWithAudio
- Category: partner/video/Kling
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

Kling 2.6 Text to Video with Audio is a ComfyUI node registered by `comfy_api_nodes.nodes_kling`. The live metadata did not provide a longer description.
