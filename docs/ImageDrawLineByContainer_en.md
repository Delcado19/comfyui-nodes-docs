...
The ImageDrawLineByContainer node is designed to draw lines on an image by specifying start and end points, color, and other drawing parameters. It abstracts the complexity of image operations, making it easy to integrate line drawing functionality into image processing workflows.

# Input types
## Required
- container
    - The container parameter represents the image data on which the line will be drawn. It is crucial for determining the dimensions and canvas on which the line will be rendered.
    - Comfy dtype: IMAGE
...
- blue
    ...
    - Python dtype: int
- alpha
    - The alpha (transparency) component of the line color.
    - Comfy dtype: FLOAT
    - Python dtype: int
- SSAA
    - Specifies the supersampling anti-aliasing factor to improve the quality of line rendering.
    - Comfy dtype: INT
    - Python dtype: int
- method
