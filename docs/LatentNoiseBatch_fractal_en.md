# Documentation
- Class name: LatentNoiseBatch_fractal
- Category: RES4LYF/noise
- Output node: False
- Repo Ref: https://github.com/ClownsharkBatwing/RES4LYF

LatentNoiseBatch_fractal is a ComfyUI node registered by `custom_nodes.RES4LYF`. The live metadata did not provide a longer description.
...
- alpha
    ...
    - Python dtype: float
- k_flip
    - The k_flip input is used by this node during execution.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
- steps
...
## Optional
- alphas
    - The alphas input is used by this node during execution.
    - Comfy dtype: SIGMAS
    - Python dtype: object
- ks
    - The ks input is used by this node during execution.
    - Comfy dtype: SIGMAS
    - Python dtype: object
- steps_
