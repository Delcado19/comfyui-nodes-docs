# Documentation
- Class name: LtxApi25AudioToVideo
...
## Required
- audio
    - Audio track driving the video. Its length (2-20 seconds) sets the video duration.
    - Comfy dtype: AUDIO
    - Python dtype: object
- model
...
## Optional
- image
    - Optional first frame to be used for the video.
    - Comfy dtype: IMAGE
