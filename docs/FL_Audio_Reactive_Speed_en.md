# Documentation
- Class name: FL_Audio_Reactive_Speed
...
- mask
    ...
    - Python dtype: torch.Tensor
- base_speed
    - The base_speed input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- speed_intensity
    - The speed_intensity input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- interpolation
