# Documentation
- Class name: FL_Fal_Seedream_Edit
...
- use_custom_resolution
    - The use_custom_resolution input is used by this node during execution.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
- auto_scale_to_minimum
    - The auto_scale_to_minimum input is used by this node during execution.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
- custom_width
