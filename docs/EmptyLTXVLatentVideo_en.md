# Documentation
- Class name: EmptyLTXVLatentVideo
- Category: model/latent/ltxv
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

EmptyLTXVLatentVideo is a ComfyUI node registered by `comfy_extras.nodes_lt`. The live metadata did not provide a longer description.
