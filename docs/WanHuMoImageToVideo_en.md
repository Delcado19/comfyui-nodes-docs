# Documentation
- Class name: WanHuMoImageToVideo
- Category: model/conditioning/wan/humo
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

WanHuMoImageToVideo is a ComfyUI node registered by `comfy_extras.nodes_wan`. The live metadata did not provide a longer description.
