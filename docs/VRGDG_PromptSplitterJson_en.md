# Documentation
- Class name: VRGDG_PromptSplitterJson
- Category: VRGDG
- Output node: False
- Repo Ref: https://github.com/vrgamegirl19/comfyui-vrgamedevgirl

VRGDG_PromptSplitterJson is a ComfyUI node registered by `custom_nodes.comfyui-vrgamedevgirl`. The live metadata did not provide a longer description.
...
## Optional
- file_path
    - The file_path input is used by this node during execution.
    - Comfy dtype: STRING
    - Python dtype: str
- index
...
- text_output_16
    ...
    - Python dtype: str
- summary_output
    - The summary_output output is produced by this node.
    - Comfy dtype: STRING
    - Python dtype: str
