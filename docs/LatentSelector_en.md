...
The LatentSelector node aims to filter and select specific latent images from a given set based on user-defined indices. It enables customization of the latent image dataset by allowing selection of specific images, thus facilitating targeted manipulation or analysis of these images.
...
- selected_indexes
    - A string specifying the indices of the latent images to select. Supports individual indices and ranges, allowing flexible selection within the dataset.
    - Comfy dtype: STRING
    - Python dtype: str

# Output types
- latent
    - The set of latent images filtered according to the specified indices, returned as a subset of the input images.
    - Comfy dtype: LATENT
