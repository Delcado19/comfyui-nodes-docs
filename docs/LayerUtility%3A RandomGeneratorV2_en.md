# Documentation
- Class name: LayerUtility: RandomGeneratorV2
...
## Required
- min_value
    - The min_value input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- max_value
    - The max_value input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- least
    - The least input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- float_decimal_places
    - The float_decimal_places input is used by this node during execution.
    - Comfy dtype: INT
    - Python dtype: int
- seed
...
- float
    ...
    - Python dtype: float
- bool
    - The bool output is produced by this node.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
