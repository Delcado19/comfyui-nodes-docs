# Documentation
- Class name: WanCameraImageToVideo
- Category: model/conditioning/wan/camera
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

WanCameraImageToVideo is a ComfyUI node registered by `comfy_extras.nodes_wan`. The live metadata did not provide a longer description.
...
- camera_conditions
    - The camera_conditions input is used by this node during execution.
    - Comfy dtype: WAN_CAMERA_EMBEDDING
    - Python dtype: object
