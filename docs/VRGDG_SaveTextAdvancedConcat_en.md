# Documentation
- Class name: VRGDG_SaveTextAdvancedConcat
- Category: VRGDG/General
- Output node: False
- Repo Ref: https://github.com/vrgamegirl19/comfyui-vrgamedevgirl

VRGDG_SaveTextAdvancedConcat is a ComfyUI node registered by `custom_nodes.comfyui-vrgamedevgirl`. The live metadata did not provide a longer description.
...
- folder_name
    ...
    - Python dtype: str
- file_name
    - The file_name input is used by this node during execution.
    - Comfy dtype: STRING
    - Python dtype: str
- overwrite
    ...
    - Python dtype: bool
- concat
    - The concat input is used by this node during execution.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
- text
...
- file_path
    ...
    - Python dtype: str
- json
    - The json output is produced by this node.
    - Comfy dtype: JSON
    - Python dtype: object
- json_string
    - The json_string output is produced by this node.
    - Comfy dtype: STRING
    - Python dtype: str
