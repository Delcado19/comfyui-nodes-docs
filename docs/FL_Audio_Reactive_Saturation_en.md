# Documentation
- Class name: FL_Audio_Reactive_Saturation
...
- mask
    ...
    - Python dtype: torch.Tensor
- base_saturation
    - The base_saturation input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- saturation_intensity
    - The saturation_intensity input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- invert
