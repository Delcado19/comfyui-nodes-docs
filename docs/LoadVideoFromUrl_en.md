...
The LoadVideoFromUrl node loads video content from a URL and converts it to a format suitable for further processing or analysis. It supports various URL formats, including direct links to video files, and converts them to a standardized video format used internally.

# Input types
## Required
- video
- The "video" parameter is a string representing the URL of the video to load. It is crucial for determining the source of video acquisition and processing.
    - Comfy dtype: STRING
    - Python dtype: str
- force_rate
- Specify the target frame rate for loading the video, allowing control of playback speed or frame rate normalization.
    - Comfy dtype: INT
    - Python dtype: Optional[float]
- force_size
- Define the target resolution for loading the video, enabling resizing or aspect‑ratio adjustment.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: Optional[str]
- custom_width
- Set a custom width for the loaded video, overriding the default or specified 'force_size' width.
    - Comfy dtype: INT
    - Python dtype: Optional[int]
- custom_height
- Set a custom height for the loaded video, overriding the default or specified 'force_size' height.
    - Comfy dtype: INT
    - Python dtype: Optional[int]
- frame_load_cap
- Limit the number of frames loaded from the video, useful for processing long videos or sampling.
    - Comfy dtype: INT
    - Python dtype: Optional[int]
- skip_first_frames
- Skip a specified number of frames at the beginning of the video, to omit unwanted content or intros.
    - Comfy dtype: INT
    - Python dtype: Optional[int]
- select_every_nth
- Load every nth frame from the video, allowing reduced frame rates or selective frame analysis.
    - Comfy dtype: INT
    - Python dtype: Optional[int]
## Optional
- meta_batch
- Enable batch processing of video metadata, optimizing scenarios where video metadata is critical.
    - Comfy dtype: VHS_BatchManager
    - Python dtype: Optional[bool]

# Output types
- frames
- Represents the list of tensors for the loaded video.
    - Comfy dtype: IMAGE
    - Python dtype: List[torch.Tensor]
- frame_count
- Contains a list of frame counts for each loaded video.
    - Comfy dtype: INT
    - Python dtype: List[int]
- has_video
- Indicates a boolean value showing whether any video was loaded successfully.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
