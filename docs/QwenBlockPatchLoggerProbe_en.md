# Documentation
- Class name: QwenBlockPatchLoggerProbe
- Category: ImageDirector/probe
- Output node: False
- Repo Ref: https://github.com/Comfy-Org/ComfyUI

Qwen Block Patch Logger (Probe) is a ComfyUI node registered by `custom_nodes.sam3_attn_probe`. The live metadata did not provide a longer description.
