# Documentation
- Class name: VAEDecodeAudioTiled
- Category: model/latent
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

VAE Decode Audio (Tiled) is a ComfyUI node registered by `comfy_extras.nodes_audio`. The live metadata did not provide a longer description.
