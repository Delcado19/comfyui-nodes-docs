# Documentation
- Class name: EmptyARVideoLatent
- Category: model/latent/autoregressive
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

EmptyARVideoLatent is a ComfyUI node registered by `comfy_extras.nodes_ar_video`. The live metadata did not provide a longer description.
