# Documentation
- Class name: EmptyMochiLatentVideo
- Category: model/latent/mochi
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

EmptyMochiLatentVideo is a ComfyUI node registered by `comfy_extras.nodes_mochi`. The live metadata did not provide a longer description.
