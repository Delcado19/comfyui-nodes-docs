...
The HighRes-Fix Script node aims to enhance image resolution and quality in a customizable way. It utilizes various upscaling techniques, control networks, and preprocessing steps to optimize images, providing options for seed consistency, denoising, and iterative refinement. This node integrates with animation and control network scripts, adapting to specific high-resolution enhancement needs while maintaining flexibility to work with different upscaling models and preprocessors.

# Input types
## Required
- upscale_type
    - The upscaling method to use, affecting the quality and approach of the high-resolution output.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- hires_ckpt_name
    - The checkpoint name of the high-resolution model, indicating the specific model version or configuration used for upscaling.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- latent_upscaler
    - Identifies the latent space upscaling method, enhancing image details at a basic level before pixel-level adjustments.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- pixel_upscaler
    - Defines the pixel-level upscaling method, further refining image details after latent space enhancement.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- upscale_by
    - Determines the scale factor for the upscaling process, directly affecting the size and details of the final image.
    - Comfy dtype: FLOAT
    - Python dtype: float
- use_same_seed
    - Controls whether the same seed is used throughout the upscaling process, ensuring consistency of random elements.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
- seed
    - The initial seed value for the random process, providing a starting point for reproducibility and variation control.
    - Comfy dtype: INT
    - Python dtype: int
- hires_steps
    - Specifies the number of steps to be performed in the high-resolution enhancement process, affecting the depth of refinement.
    - Comfy dtype: INT
    - Python dtype: int
- denoise
    ...
    - Python dtype: bool
- iterations
    - The number of iterations to run the upscaling process, allowing multiple refinements.
    - Comfy dtype: INT
    - Python dtype: int
- use_controlnet
    - Determines whether a control network is used for guided upscaling, affecting the direction and quality of enhancement.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
- control_net_name
    - The name of the control network to use, specifying the model used for guided upscaling.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- strength
    - The strength of the control network's influence on the upscaling process, adjusting the degree of guidance.
    - Comfy dtype: FLOAT
    - Python dtype: float
- preprocessor
    - The preprocessing method used to prepare the image for upscaling, affecting initial quality and compatibility.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- preprocessor_imgs
    - The preprocessed image ready for upscaling, serving as input for the enhancement process.
    - Comfy dtype: BOOLEAN
    - Python dtype: list
## Optional
- script
...
# Output types
- script
    - The script configuration resulting after applying high-resolution fix, encapsulating all parameters specified and adjustments made during the process.
    - Comfy dtype: SCRIPT
    - Python dtype: dict
