...
- vae_name
    ...
    - Python dtype: str
- chatglm3_name
    - The chatglm3_name input is used by this node during execution.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- lora_name
...
- optional_lora_stack
    ...
    - Python dtype: object
- auto_clean_gpu
    - The auto_clean_gpu input is used by this node during execution.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
## Hidden
- prompt
