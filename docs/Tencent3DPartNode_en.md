# Documentation
- Class name: Tencent3DPartNode
- Category: partner/3d/Tencent
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

Automatically perform component identification and generation based on the model structure.

# Input types
## Required
- model_3d
    - 3D model in FBX format. Model should have less than 30000 faces.
