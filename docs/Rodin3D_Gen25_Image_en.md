# Documentation
- Class name: Rodin3D_Gen25_Image
- Category: partner/3d/Rodin
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

Generate a 3D model from 1-5 reference images via Rodin Gen-2.5. Pick a mode (Fast / Regular / Extreme-High) to tune quality vs. cost.

# Input types
## Required
- images
    - 1-5 images. The first image is used for materials when multi-view.
