# Documentation
- Class name: TripoRigNode
- Category: partner/3d/Tripo
- Output node: True
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

Tripo: Rig model is a ComfyUI node registered by `comfy_api_nodes.nodes_tripo`. The live metadata did not provide a longer description.
...
- model_file
    ...
    - Python dtype: str
- rig task_id
    - The rig task_id output is produced by this node.
