# Documentation
- Class name: VRGDG_LoadAudioSplit_HUMO_Transcribe
- Category: VRGDG
- Output node: False
- Repo Ref: https://github.com/vrgamegirl19/comfyui-vrgamedevgirl

VRGDG_LoadAudioSplit_HUMO_Transcribe is a ComfyUI node registered by `custom_nodes.comfyui-vrgamedevgirl`. The live metadata did not provide a longer description.
