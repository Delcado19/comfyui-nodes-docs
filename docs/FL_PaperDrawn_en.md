...
- mask
    ...
    - Python dtype: torch.Tensor
- angle_num
    - The angle_num input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- samp_num
    - The samp_num input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- line_width
    ...
    - Python dtype: float
- vignette
    - The vignette input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- fps
