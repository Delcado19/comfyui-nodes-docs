# Documentation
- Class name: Image Save with Prompt File (WLSH)
- Category: WLSH Nodes/IO
- Output node: True
- Repo Ref: https://github.com/wallish77/wlsh_nodes

Image Save with Prompt File (WLSH) is a ComfyUI node registered by `custom_nodes.wlsh_nodes`. The live metadata did not provide a longer description.
