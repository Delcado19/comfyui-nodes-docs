# Documentation
- Class name: EmptyCosmosLatentVideo
- Category: model/latent/cosmos
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

EmptyCosmosLatentVideo is a ComfyUI node registered by `comfy_extras.nodes_cosmos`. The live metadata did not provide a longer description.
