...
The SaltAudioVisualizer node is designed to create a visual representation of audio data. It processes audio input to generate visualizations that can be used for analysis or aesthetic purposes, highlighting the structure, frequency content, and dynamic characteristics of the audio.
...
- audio
    ...
    - Python dtype: bytes
- frame_rate
    - The 'frame_rate' parameter specifies the frame rate of the visualization, affecting the temporal resolution of the generated visual output.
    - Comfy dtype: INT
    - Python dtype: int

## Optional
- start_frame
    - The 'start_frame' parameter defines the starting point of the audio segment to be visualized, allowing selective visualization of specific portions of the audio.
    - Comfy dtype: INT
    - Python dtype: int
- end_frame
    - The 'end_frame' parameter determines the ending point of the audio segment to be visualized, enabling customization of the visualization length.
    - Comfy dtype: INT
    - Python dtype: int
