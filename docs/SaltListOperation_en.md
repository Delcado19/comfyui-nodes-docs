...
The SaltListOperation node is designed to perform numerical operations on schedule lists, allowing dynamic adjustment of schedule values based on predefined operations. This node facilitates manipulating numerical lists in a scheduling context, enabling more complex and customized scheduling behavior.

# Input types
## Required
- operation
    - The 'operation' parameter specifies the type of numerical operation to apply to the schedule list. Its choice determines how the list values are manipulated, thereby affecting the characteristics of the final schedule.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: List[str]
- output_type
    - The 'output_type' parameter defines the desired data type of the operation result, allowing the output format to be customized to meet subsequent processing requirements.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: List[str]
## Optional
- schedule_list_a
    - The 'schedule_list_a' parameter represents the primary numerical list to be operated on, serving as one of the inputs for the specified operation.
    - Comfy dtype: *
    - Python dtype: List[float]
- schedule_list_b
    - The 'schedule_list_b' parameter is the secondary numerical list involved in operations that require two input lists (such as 'add' or 'subtract').
    - Comfy dtype: *
    - Python dtype: List[float]
- expression
    - The 'expression' parameter allows input of custom mathematical expressions to apply to the schedule list, providing advanced flexibility for list operations.
    - Comfy dtype: STRING
    - Python dtype: str

# Output types
- schedule_list
    - 'schedule_list' is the result of applying the specified operation to the input schedule list. It reflects the modified sequence of values and can be used for further scheduling purposes.
    - Comfy dtype: *
    - Python dtype: List[float]
