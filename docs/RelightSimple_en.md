...
The RelightSimple node adjusts image lighting based on provided normal map and directional light parameters. It enables dynamic relighting by changing light direction and intensity to simulate different lighting conditions.

# Input types
## Required
- image
    - Input image requiring relighting. Serves as the base for lighting adjustments.
    - Comfy dtype: IMAGE
    - Python dtype: torch.Tensor
- normals
    - Normal map corresponding to the input image, used to calculate how light interacts with surfaces.
    - Comfy dtype: IMAGE
    - Python dtype: torch.Tensor
- x_dir
    - X component of the light source direction, affecting where light appears to come from.
    - Comfy dtype: FLOAT
    - Python dtype: float
- y_dir
    - Y component of the light source direction, affecting the vertical angle of incident light.
    - Comfy dtype: FLOAT
    - Python dtype: float
- brightness
    - Controls light source intensity, allowing brighter or dimmer lighting effects.
    - Comfy dtype: FLOAT
    - Python dtype: float

# Output types
- image
    - Output image adjusted based on the provided normal map and light direction parameters.
    - Comfy dtype: IMAGE
    - Python dtype: torch.Tensor
