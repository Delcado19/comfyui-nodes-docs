...
Simulates film grain, vignette, and edge blur, supports depth map input to simulate defocus.
This node is a repackaging of digitaljohn/comfyui-propost, thanks to the original author.
