...
- TAPose
    - The TAPose input is used by this node during execution.
    - Comfy dtype: BOOLEAN
    - Python dtype: bool
## Optional
- Seed
    ...
    - Python dtype: int
- Material_Type
    - The Material_Type input is used by this node during execution.
    - Comfy dtype: COMBO
    - Python dtype: object
- Polygon_count
    - The Polygon_count input is used by this node during execution.
    - Comfy dtype: COMBO
    - Python dtype: object
## Hidden
