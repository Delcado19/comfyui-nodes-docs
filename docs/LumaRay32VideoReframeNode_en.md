# Documentation
- Class name: LumaRay32VideoReframeNode
- Category: partner/video/Luma
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

Change the aspect ratio of an existing video, using Luma Ray 3.2 to fill the newly exposed canvas areas. Source video up to 30 seconds. Billed per second of output.

# Input types
## Required
- video
    - Source video to reframe. Up to 30 seconds.
    - Comfy dtype: VIDEO
    - Python dtype: object
- prompt
    - Describes how the newly exposed canvas areas should be filled.
    - Comfy dtype: STRING
    - Python dtype: str
- aspect_ratio
