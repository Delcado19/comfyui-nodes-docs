# Documentation
- Class name: HunyuanImageToVideo
- Category: model/conditioning/hunyuan video
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

HunyuanImageToVideo is a ComfyUI node registered by `comfy_extras.nodes_hunyuan`. The live metadata did not provide a longer description.
...
- batch_size
    ...
    - Python dtype: int
- guidance_type
    - The guidance_type input is used by this node during execution.
    - Comfy dtype: COMBO
    - Python dtype: object
## Optional
- start_image
