# Documentation
- Class name: ImageBatchJoinWithTransition
...
## Required
- images_1
    - The images_1 input is used by this node during execution.
    - Comfy dtype: IMAGE
    - Python dtype: torch.Tensor
- images_2
    - The images_2 input is used by this node during execution.
    - Comfy dtype: IMAGE
    - Python dtype: torch.Tensor
- start_index
