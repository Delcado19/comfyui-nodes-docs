# Documentation
- Class name: CosmosImageToVideoLatent
- Category: model/conditioning/cosmos
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

CosmosImageToVideoLatent is a ComfyUI node registered by `comfy_extras.nodes_cosmos`. The live metadata did not provide a longer description.
