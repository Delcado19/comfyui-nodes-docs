# Documentation
- Class name: ConditioningSetPropertiesAndCombine
- Category: advanced/hooks/cond single
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

Cond Set Props Combine is a ComfyUI node registered by `comfy_extras.nodes_hooks`. The live metadata did not provide a longer description.

# Input types
## Required
- cond
    - The cond input is used by this node during execution.
