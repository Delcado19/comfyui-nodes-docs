...
The SaltParallaxMotion node is designed to generate parameter schedules for parallax motion effects in audio-visual presentations. It utilizes various inputs to dynamically adjust the motion and depth of elements, creating a more immersive and engaging experience.
...
- **`front_x_min`**
    - Comfy dtype: `FLOAT`
    - The minimum X-axis value of the front layer's motion range, used to contribute to the depth effect in parallax motion.
    - Python dtype: `float`
- **`front_x_max`**
    - Comfy dtype: `FLOAT`
    - The maximum X-axis value of the front layer's motion range, used to contribute to the depth effect in parallax motion.
    - Python dtype: `float`
- **`front_y_min`**
    - Comfy dtype: `FLOAT`
    - The minimum Y-axis value of the front layer's motion range, used to contribute to the depth effect in parallax motion.
    - Python dtype: `float`
- **`front_y_max`**
    - Comfy dtype: `FLOAT`
    - The maximum Y-axis value of the front layer's motion range, used to contribute to the depth effect in parallax motion.
    - Python dtype: `float`
- **`front_z_min`**
    - Comfy dtype: `FLOAT`
    - The minimum Z-axis value of the front layer's motion range, used to contribute to the depth effect in parallax motion.
    - Python dtype: `float`
- **`front_z_max`**
    - Comfy dtype: `FLOAT`
    - The maximum Z-axis value of the front layer's motion range, used to contribute to the depth effect in parallax motion.
    - Python dtype: `float`
- **`back_x_min`**
    - Comfy dtype: `FLOAT`
    - The minimum X-axis value of the back layer's motion range, used to contribute to the depth effect in parallax motion.
    - Python dtype: `float`
- **`back_x_max`**
    - Comfy dtype: `FLOAT`
    - The maximum X-axis value of the back layer's motion range, used to contribute to the depth effect in parallax motion.
    - Python dtype: `float`
- **`back_y_min`**
    - Comfy dtype: `FLOAT`
    - The minimum Y-axis value of the back layer's motion range, used to contribute to the depth effect in parallax motion.
    - Python dtype: `float`
- **`back_y_max`**
    - Comfy dtype: `FLOAT`
    - The maximum Y-axis value of the back layer's motion range, used to contribute to the depth effect in parallax motion.
    - Python dtype: `float`
- **`back_z_min`**
    - Comfy dtype: `FLOAT`
    - The minimum Z-axis value of the back layer's motion range, used to contribute to the depth effect in parallax motion.
    - Python dtype: `float`
- **`back_z_max`**
    - Comfy dtype: `FLOAT`
    - The maximum Z-axis value of the back layer's motion range, used to contribute to the depth effect in parallax motion.
    - Python dtype: `float`
