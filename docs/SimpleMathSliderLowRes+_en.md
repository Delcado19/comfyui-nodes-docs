# Documentation
- Class name: SimpleMathSliderLowRes+
...
- value
    ...
    - Python dtype: int
- min
    - The min input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- max
    - The max input is used by this node during execution.
    - Comfy dtype: FLOAT
    - Python dtype: float
- rounding
    - The rounding input is used by this node during execution.
    - Comfy dtype: INT
    - Python dtype: int
