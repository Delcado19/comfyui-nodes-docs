# Documentation
- Class name: EmptyHunyuanVideo15Latent
- Category: model/latent/hunyuan video
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

Empty HunyuanVideo 1.5 Latent is a ComfyUI node registered by `comfy_extras.nodes_hunyuan`. The live metadata did not provide a longer description.
