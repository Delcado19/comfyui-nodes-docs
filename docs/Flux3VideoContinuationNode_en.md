# Documentation
- Class name: Flux3VideoContinuationNode
- Category: partner/video/BFL
- Output node: False
- Repo Ref: https://github.com/comfyanonymous/ComfyUI

Continues a video with FLUX 3: the new clip carries on from the final frames of the one you provide.

# Input types
## Required
- video
    - The clip to continue.
    - Comfy dtype: VIDEO
    - Python dtype: object
- prompt
    - What the continuation should show; the prompt is interpreted and expanded before generation.
    - Comfy dtype: STRING
    - Python dtype: str
- aspect_ratio
