...
- prompt
    - Enter text description of object to segment
    - Comfy dtype: STRING
    - Python dtype: str
- sam2_model
    - SAM2 model size: Tiny (fastest) to Large (best quality)
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- dino_model
    - GroundingDINO model for text-to-box detection
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- device
...
## Optional
- threshold
    - Detection threshold (higher = more strict)
    - Comfy dtype: FLOAT
    - Python dtype: float
- mask_blur
