...
The ttN advanced xyPlot node is designed to provide advanced plotting functionality, capable of generating and manipulating XY plots with enhanced features such as grid spacing, latent index consideration, and individual output control. It offers a customizable framework for visualizing complex data relationships and patterns.

# Input types
## Required
- grid_spacing
    - Specifies the spacing between points on the grid, affecting the density and separation of plotted points, thereby influencing the granularity and overall appearance of the chart.
    - Comfy dtype: INT
    - Python dtype: int
- latent_index
    - Identifies specific latent dimensions or indices to be visualized, enabling targeted exploration and analysis of high-dimensional data spaces.
    - Comfy dtype: INT
    - Python dtype: int
- output_individuals
    - Controls whether individual data points are output separately, allowing detailed inspection and analysis of each point in the chart.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: bool
- flip_xy
    - Determines whether to swap the x and y axes, enabling alternative perspectives and orientations of the plotted data.
    - Comfy dtype: COMBO[STRING]
    - Python dtype: str
- x_plot
    - Provides data points for the x-axis, constituting one dimension of the chart's data representation.
    - Comfy dtype: STRING
    - Python dtype: str
- y_plot
    - Provides data points for the y-axis, constituting another dimension of the chart's data representation.
    - Comfy dtype: STRING
    - Python dtype: str

# Output types
- adv_xyPlot
    - Outputs a dictionary containing chart data, including x and y coordinates, grid spacing, latent indices, and output control information, encapsulating the comprehensive configuration of the chart.
